...
import AbandonTable from "@/components/common/orders/table/abandon/AbandonTable";
import PageTitle from "@/components/common/PageTitle";
import MOCK_DATA from "@/mock";
import { NextPageWithLayout } from "@/pages/_app";
import styles from "@/styles/components/admin/orders/abandoned-orders.module.scss";
import { MdClose, MdSearch } from "react-icons/md";

const AbandonedOrders: NextPageWithLayout = () => {
  return (
    <>
      <PageTitle title="Abandoned Orders | Admin Panel" />
      <main className={styles.container}>
        ...
        <div className={styles.dataGridContainer}>
          <AbandonTable data={MOCK_DATA} />
        </div>
      </main>
    </>
  );
};
AbandonedOrders.getLayout = function getLayout(page) {
